...
#| warning: false
using Downloads, CSV
dicturl = "https://raw.githubusercontent.com/neelsmith/CitableParserBuilder.jl/main/test/data/posdict.csv"
dictcsv = Downloads.download(dicturl)
...
textoutput = delimited(parsed; registry = urndict)
```
...
fromcex(cexoutput, AnalyzedToken)
```
